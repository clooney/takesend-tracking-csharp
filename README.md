# Takesend Logistics Tracking API For Csharp
Takesend Logistics Tracking API and webhook make it easy to integrate Takesend Logistics Tracking function into your own project. Support APIs Client Libraries for csharp
